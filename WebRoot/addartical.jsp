    ...
    <div class="tab">
      <div class="tab-body">
        ...
        <div class="tab-panel active" id="tab-set">
        	<form method="post" class="form-x" action="addartical">
                ...
                <div class="form-group">
                    <div class="label"><label for="sitename">date</label></div>
                    <div class="field">
                    	<input type="hidden" class="input" id="sitename" name="date" size="50" placeholder="时间" />
                    </div>
                </div>
