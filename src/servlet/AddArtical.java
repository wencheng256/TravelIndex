...
public class AddArtical extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		art.setDate(request.getParameter("date"));
		art.setUsers(Integer.parseInt(request.getParameter("user")));
		art.setTravels(Integer.parseInt(request.getParameter("travel")));
		if(art.insert())
		{
			response.sendRedirect("artical.jsp");
		}else
		{
